      ...
      <div class="container mx-auto">
        <div class="grid grid-cols-12 gap-30">
          <div class="lg:col-span-4">
            <vs-button
              class="save-product save-product-s absolute top-14 -right-12 z-20"
              color="#D1D5DB"
              type="flat"
              icon-pack="fal"
              icon=" fa-bookmark"
          ...
          <div class="lg:col-span-3">
            <div class="sidebar-product rounded-lg border border-cool-200 p-3 mt-14">
        ...
        <div class="grid grid-cols-12 gap-30 mt-10">
      ...
      <vs-tab @click="colorx = '#EF4444'" label="مشخصات">
        <div class="con-tab-ejemplo">
          <div class="grid grid-cols-5 gap-3">
            <div class="col-span-1 bg-cool-100 px-2 py-2 text-cool-700 text-center rounded-sm text-sm font-black">وزن محصول</div>
            <div class="col-span-4 bg-cool-100 px-2 py-2 text-cool-700 text-right rounded-sm text-sm font-thin">220 تا 230 گرم می باشد</div>
            <div class="col-span-1 bg-cool-100 px-2 py-2 text-cool-700 text-center rounded-sm text-sm font-black">وزن محصول</div>
            <div class="col-span-4 bg-cool-100 px-2 py-2 text-cool-700 text-right rounded-sm text-sm font-thin">220 تا 230 گرم می باشد</div>
            <div class="col-span-1 bg-cool-100 px-2 py-2 text-cool-700 text-center rounded-sm text-sm font-black">وزن محصول</div>
            <div class="col-span-4 bg-cool-100 px-2 py-2 text-cool-700 text-right rounded-sm text-sm font-thin">220 تا 230 گرم می باشد</div>
